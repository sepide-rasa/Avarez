                ...
                { //ذخیره
                    ...
                    else
                    {
                        m.prs_tblShakhsHaghighi_HoghoghiInsert(shakhs.fldName, shakhs.fldFamily, shakhs.fldNationalCode, shakhs.fldCodeEghtesadi, shakhs.fldTypeShakhsId,
                            shakhs.fldCodePosti, shakhs.fldCodeShobe, Convert.ToInt32(Session["TarafGharardadId"]), Convert.ToInt64(Session["TaxUserId"]), shakhs.fldDesc);
        ...
        public ActionResult SaveTarafGharardad(int Id, int gharardadId, string code)
        {
            ...
            try
            {
                ...
                if (gharardadId == 0)
                {
                    ...
                    p.prs_tblTarfGharardadInsert(GId,Id, code, file, fileD, Convert.ToInt64(Session["TaxUserId"]), "");
                    Msg = "ذخیره با موفقیت انجام شد.";
                    MsgTitle = "ذخیره موفق";
                ...
                {
                    p.prs_tblTarfGharardadUpdate(gharardadId,Id, code, file, fileD, Convert.ToInt64(Session["TaxUserId"]), "");
                    Msg = "ویرایش با موفقیت انجام شد.";
                    MsgTitle = "ویرایش موفق";
                }
